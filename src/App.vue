<template>
  ...
  <div class="veto-main-grid veto-background veto-font">
    <div class="veto-main-grid-navbar">
      <nav class="navbar navbar-expand-sm veto-navbar veto-background-highlight border-bottom border-1">
        <div class="container-fluid veto-navbar-inner">
          <div class="navbar-brand veto-navbar-brand">
            <img src="./assets/veto_logo.svg" class="veto-navbar-logo" alt="VETO" width="1280">
          </div>

          <span class="veto-action-button">
            <button class="navbar-toggler veto-neutral" type="button" data-bs-toggle="collapse" data-bs-target="#navbarButtons"
          ...
          <div class="collapse navbar-collapse show" id="navbarButtons">
            <div class="ms-auto text-end veto-navbar-list-wrap">
              <ul class="navbar-nav veto-navbar-list">
                <li class="veto-nav-item">
                  <button class="veto-nav-button" @click="showImportPopup()">Import</button>
                </li>
                <li class="veto-nav-item">
                  <button class="veto-nav-button" @click="showExportPopup()">Export</button>
                </li>
                <li class="veto-nav-item">
                  <button class="veto-nav-button" @click="showSettingsPopup()">Settings</button>
                </li>
                <li class="veto-nav-item">
                  <button class="veto-nav-button" @click="showHelpPopup()">Help</button>
                </li>
                <li class="veto-nav-item">
                  <button class="veto-nav-button veto-theme-switch" @click="toggleDarkMode" :title="isDarkMode ? 'Switch to light mode' : 'Switch to dark mode'">
...
export default defineComponent({
  ...
  methods: {
    ...
    toggleDarkMode() {
      const nextTheme = this.isDarkMode ? "DEFAULT" : "DARK";
      this.vetoStore.updateAppSettings({
        ...this.vetoStore.appSettings,
        vetoColorScheme: nextTheme,
      });
    }
  }
});
...
.navbar {
  border-bottom-color: var(--veto-color-border) !important;
}
...
.veto-theme-switch svg {
  width: 1.2rem;
}

.veto-theme-switch span {
  font-size: 0.88rem;
  font-weight: 600;
  width: 2.2rem;
}
