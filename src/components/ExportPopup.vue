      ...
      <template #popup-body>
            <div class="veto-group">
              ...
              <div class="veto-input">
                <label for="downloadColumnModeInput" class="veto-input-label">Select columns to export</label>
              ...
              <div class="veto-input">
                <label for="downloadRowModeInput" class="veto-input-label">Select rows to export</label>
                <span class="veto-form-multiselect">
              ...
              <div class="veto-input">
                <label for="downloadModeInput" class="veto-input-label">Select data format</label>
                <span class="veto-form-multiselect">
              ...
              <template v-if="hasMultiValueView && selectedDownloadFormat !== 'JSON'">
                <div class="veto-input">
                  <label for="delimiter" class="veto-input-label">Value Delimiter</label>
                  <span class="veto-form-multiselect">
