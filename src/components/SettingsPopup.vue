      ...
      <template #popup-body >
        <div class="veto-group">
          ...
          <div class="veto-input">
            <label for="afterLabelingModeInput" class="veto-input-label">Automatic actions after labeling</label>
          ...
          <!-- Veto colors -->
          <div class="veto-input">
            <label for="vetoColorScheme" class="veto-input-label">Colors of the user interface</label>
          ...
          <!-- Annotation colors -->
          <div class="veto-input">
            <label for="annotationColorScheme" class="veto-input-label">Default color scheme for annotations</label>
          ...
          <!-- Highlight color -->
          <div class="veto-input">
            <label for="highlightColor" class="veto-input-label">Highlight color for search results</label>
            <div>
...
export default defineComponent({
  ...
  watch: {
    "appSettings.vetoColorScheme"(newValue: string) {
      this.cachedAppSettings.vetoColorScheme = newValue;
    }
  }
});
</script>
...
.invalid-key-selector {
  border: 1px solid var(--veto-color-error);
  border-radius: var(--veto-radius-sm);
}

.key-conflict {
  color: var(--veto-color-error);
}
