  ...
  <Popup :id='id' ref="importPopup" header="Import your files into VETO" :zIndex="1052"  @confirm="onUploadClicked"
    ...
    <template #popup-body>
      ...
      <div class="tab-content" id="importPopupContent">
        <div class="tab-pane show active" id="import-tab-pane" role="tabpanel" aria-labelledby="import-tab"
             tabindex="0">
            ...
            <div class="veto-group">
              ...
              <div class="veto-input">
                ...
                <div class="input-group">
                  ...
                  <input @change="onSelectedFileChanged()" class="form-control" id="fileInput" type="file"
                  ...
                  <input @change="onExternalTextFileChanged()" id="sampleInput" class="form-control"
        ...
        <div class="tab-pane" id="summary-tab-pane" role="tabpanel" aria-labelledby="summary-tab" tabindex="0">
