<template>
  ...
  <div id="vetoTable" class="h-100 veto-border" style="flex-flow: column; display: flex;">
    ...
    <div id="vetoTableHeader" style="flex: 0 1 auto;">
      <div class="veto-container-row">
        ...
        <span class="veto-container-item veto-action-button">
          <button class="veto-size-2 veto-neutral" title="Fix all unambiguous conflicts" style="font-weight: bold;"
        ...
        <div class="ms-auto d-flex">
          ...
          <span v-if="columnData.containsMultiValueAttributes" title="Value Order"
            ...
            <label for="valueOrder" class="form-label veto-header-icon-label">
              <font-awesome-icon icon="fa-arrow-down-short-wide" class="veto-header-icon"
                                 v-if="vetoStore.currentValueOrder.type === 'ID'"></font-awesome-icon>
              <font-awesome-icon icon="fa-arrow-down-1-9" class="veto-header-icon"
                                 v-if="vetoStore.currentValueOrder.type === 'END' || vetoStore.currentValueOrder.type === 'START'"></font-awesome-icon>
              <font-awesome-icon icon="fa-arrow-down-a-z" class="veto-header-icon"
          ...
          <span class="veto-container-item veto-action-button">
            <button class="veto-multi-toggle" :disabled="hasMultipleValues" @click="switchMultiValueView"
...
.rounded-inner-bottom:first-child {
  border-radius: 0 0 0 calc(var(--veto-radius-md) - 2px);
}

.rounded-inner-bottom:last-child {
  border-radius: 0 0 calc(var(--veto-radius-md) - 2px) 0;
}

.rounded-inner-bottom:only-child {
  border-radius: 0 0 calc(var(--veto-radius-md) - 2px) calc(var(--veto-radius-md) - 2px);
}

.veto-border {
  border: 2px solid color-mix(in srgb, var(--veto-color-border) 82%, transparent);
  border-radius: var(--veto-radius-md);
  overflow: hidden;
}
...
.veto-table > thead > tr > th > span:not(.veto-attribute-icon) {
