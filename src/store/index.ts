 ...
 state: (): State => ({
  appSettings: getDefaultSettings(),
   columnData: {
    ...
    nextId: 4,
    attributes: {
      'File Import': {color: '#C96565', validationRegEx: null},
      'Validation': {color: '#667FD3', validationRegEx: null},
      'File Export': {color: '#C3B455', validationRegEx: null},
      'Try it out': {color: '#69B171', validationRegEx: null},
    },
